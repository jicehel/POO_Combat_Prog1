...
class Personnage { 
    ...
    public :
      ...
      Personnage(uint8_t newAttack, uint8_t newDefense, int8_t hp, char* newName); // Constructeur de la classe Personnage
      ...
      void setName(char* newName) { this->name = newName ; };                    // Le manipulateur de name
      ...
      char*   getName() const { return name;};                      // L'assesseur de l'attribut name
